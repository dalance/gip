...
pub struct Opt {
    ...
    #[structopt(short = "p", long = "plane", conflicts_with = "string", conflicts_with = "json")]
    pub show_plane: bool,

    /// Show by plane text without line break
    #[structopt(short = "s", long = "string", conflicts_with = "plane", conflicts_with = "json")]
    pub show_string: bool,

    /// Show by JSON
    #[structopt(short = "j", long = "json", conflicts_with = "plane", conflicts_with = "string")]
    pub show_json: bool,
